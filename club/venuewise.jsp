...
<html>
 ...
 <nav class="navbar navbar-expand-sm bg-secondary" id="navBar">
            <div class="container">
               <ul class="navbar-nav">
                ...
                <div>
					...
					&nbsp;&nbsp;&nbsp;
					<a href="../club/datewise.jsp" class="btn btn-light">
                        Date-wise
                    </a>
                </div>
            </div>
        ...
        <div>
        <h1 style="text-align: center">Venue-wise Events</h1>
        <table class="table table-hover" style="text-align: center">
            ...
            <%
                ...
                String sql_today = " select * from event order by venue ;";
