...
<html>
    <head>
        ...
        <title>WLUG Club</title>
        <link rel="stylesheet" href="../../css/bootstrap.css">
        <link rel="stylesheet" href="../../css/style.css">
        <link rel="icon" href="../../img/coCurricular/wlug.jpg">
    </head>
    <body>
            ...
            <div class="container">
               <ul class="navbar-nav">
                  <li class="nav-item" id="titleArena">
                    <a href="http://wcewlug.org/">
                        <img src="../../img/coCurricular/wlug.jpg" alt="not available" width="40" height="50" class="img-thumbnail">
                    </a>
                      WLUG Club
                  </li>
                </ul>
        ...
        <section class="testimonials text-center bg-light" id="about">
            <div class="container">
              <h2 class="mb-5" >About Us</h2>
               <div class="row">
                       <p>
                        Walchand Linux Users' Group is a club which promotes open source technologies. WLUG established 
                        in 2003, is an active technical club. It is a group formed by open source enthusiastic students 
                        to use and promote Linux future and interesting stuff.    
                        </p>
               </div>
            </div>
        </section>
        <table class="table table-striped" width="50%" height="50%" align="center" style="text-align: center">
            <tr>
                <td>Staff Advisor</td>
                <td>Dr. A. J. Umbarkar<br>Prof. Anil Surve</td>
            </tr>
        </table>
        ...
        <table class="table table-hover" style="text-align: center">
            ...
            <%
                ...
                String sql = "select Date, eventname from event where club='wlug' order by Date desc;";
		...
		<div id="viewMembers">
                            ...
                            <sql:query var="ob">
                                select email, rollno, department from members where club='wlug';
                            </sql:query> 
