 ...
 */
public class AllIdeas extends HttpServlet {
  ...
  /*  public String hashPassword(String password){
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String sql = "update eventidea set status ="+"'"+status+"'"+";";
            ...
            */
            ...
            obj.println("<script>alert('All Ideas')</script>");
            response.sendRedirect("http://localhost:8080/WCEclubportal/components/LoggedInPage.jsp");
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AllIdeas</title>");    
